            ...
            steps {
                script {
                    ...
                    if (params.BRANCH_BUILD != 'main' && !params.BRANCH_BUILD.startsWith('release/')) {
                        echo "Branch name is not accept for production. Exiting the pipeline."
                        exit 1 // Exit with status code 1 (optional)
                    }
        ...
        stage('Kubelet Apply') {
            ...
            steps {
                script{
                    ...
                    build job:'metadap/deploy/retx-production-deployments', parameters: [
